...
\newcommand{\foothertext}{\hspace{2mm}4\,\regtext{\c{}}, 4\,\rd}%Other forcing opening bids
...
\newcommand{\threenextratext}{\redreg{3NT 4m PRE (broken m)\pfix}}  %Blank line in 3NT box
...
\newcommand{\minraisetext}{\redreg{Limit+}} %Textbox next to inverted raise
...
\newcommand{\twowaytext}{\hspace{2mm}\redreg{XYZ/NT}}
...
\newcommand{\doubletext}{\hspace*{-18mm}\boldtext{Power X/1\,x opening}} %Other special doubles
...
\newcommand{\preempttext}{\bluereg{4m->M}\redreg{, 4M weaker}} %other info about preempts
...
\newcommand{\directhightext}{14(16)\pfix}
%\setboolean{syson}{true} %systems on
\setboolean{dntco}{true}
\newcommand{\directconvtext}{\hspace*{-2mm}\redreg{T/O, low varies seat/vul/chart}} %info line re: direct overcalls
...
\newcommand{\firstvstwocl}{\redreg{Majors, 2\,\d\ ask}\pfix{}} %1NT-2C
...
\newcommand{\toxothertext}{\redreg{Fit J/S}} %Line at bottom of Opps TOX section
...
\newcommand{\dopilevel}{\hspace*{-40mm}5 trump+\pfix} %DOPI/ROPI level
