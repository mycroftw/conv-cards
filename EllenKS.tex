...
\newcommand{\ntsptext}{\redreg{Range Ask}} %1NT-2S
...
\newcommand{\twoclresponsemiddle}{Cheap 3 2nd neg}
\newcommand{\twoclresponsebottom}{X, XX bust, pass waiting GF}
...
\newcommand{\twohdescribe}{..."Anything goes"...}
...
\newcommand{\footnotesbottom}{Mathe vs Strong minor (but systems on over non-strong ART)}
...
\newcommand{\overcalltext}{Top end extended if short in opener's suit} %Other info about simple overcalls
...
\newcommand{\cuebidtext}{Systems on/Prec D, Polish C, etc} %other cuebid comments
...
\newcommand{\firstvstwocl}{\redreg{Majors, 2\d\ asks}} %1NT-2C
