...
\setboolean{texas}{true} %MDF: see extratikz for SATexas
...
\newcommand{\majothertext}{\redreg{Kokish GT}} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\twocldescribetop}{or 8.5+ PT w/defence} %3 lines of text on left side of 2C divider
\newcommand{\twocldescribemiddle}{}
\newcommand{\twocldescribebottom}{}
\newcommand{\twoclresponsetop}{suit positive} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{Cheap 3 2nd neg\pfix{}}
\newcommand{\twoclresponsebottom}{X, XX bust, pass waiting GF\pfix{}}

\newcommand{\twodlowtext}{6} %2D point range
\newcommand{\twodhightext}{11}
\newcommand{\twoddescribe}{6 cards, ...}
...
\newcommand{\twohdescribe}{..."Anything goes"...\pfix{}}
...
\newcommand{\twosdescribe}{...style\pfix{}}
