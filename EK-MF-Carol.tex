...
\newcommand{\names}{Ellen Kuiper --- Carol Cortéz\pfix{}}
...
\newcommand{\twonsptext}{\redreg{$\rightarrow{}$3NT or minor(s)ST}} %2NT-3S
\newcommand{\twonextratext}{3NT: \redreg{5\ }\s\redreg{\ + 4\ \h}} %Blank line in 2NT box
\newcommand{\threenlowtext}{} %3NT range
\newcommand{\threenhightext}{}
\newcommand{\threenextratext}{} %Blank line in 3NT box
\newcommand{\convnttext}{\redreg{Gambling 3NT (0 o/s)}\pfix{}} % Blank lines under 3NT box
...
\newcommand{\majothertext}{2\ \c: 3, 2\ \rd: 4} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\twocldescribebottom}{\hspace{-1cm}GF, 1+controls}
\newcommand{\twoclresponsetop}{2\ \rh: double-neg\pfix{}} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{2NT:\ \rh\ positive}
\newcommand{\twoclresponsebottom}{}

\newcommand{\twodlowtext}{5} %2D point range
\newcommand{\twodhightext}{11}
\newcommand{\twoddescribe}{}
\newcommand{\twodresponse}{Ogust\pfix{}}
...
\newcommand{\twohresponse}{Ogust\pfix{}}
...
\newcommand{\twosresponse}{Ogust\pfix{}}
...
\newcommand{\footnotesmiddle}{2ND SUIT; Sandwich NT}
...
\newcommand{\preempttext}{\hspace{0.2cm}Vul\hspace{0.5cm}NV} %other info about preempts
...
\newcommand{\directconvtext}{Systems OFF/BAL} %info line re direct overcalls
...
\newcommand{\firstvstwodi}{\redreg{\d\ + major}\pfix{}} %1NT-2D
\newcommand{\firstvstwohe}{\redreg{Majors}\pfix{}} %1NT-2H
\newcommand{\firstvstwosp}{\regtext{bad \s}} %1NT-2S
\newcommand{\firstvsdbl}{\redreg{Single suit (if }\s\redreg{, good)}\pfix{}} %1NT-X
...
\newcommand{\othernttop}{\redreg{3x NAT PRE}} %two lines of other NT defense info
...
\newcommand{\slamtexttop}{Gerber only after first and last NTs\pfix{}} %Two lines for slam convention info
\newcommand{\slamtextbottom}{Specific Ks\pfix{}}
\newcommand{\dopilevel}{\hspace{-2cm}5x} %DOPI/ROPI level
