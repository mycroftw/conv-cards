...
\newcommand{\foothertext}{NONE!}%Other forcing opening bids
...
\newcommand{\majthreennote}{BAL, 3M} %Empty space next to the 1M-3NT box: I might write ``4333'' here if I play 1M-3NT as a 13-15 4333 hand.
...
\newcommand{\twoclowtext}{6} %2C point range
\newcommand{\twochightext}{12}
\newcommand{\twocldescribetop}{5+ cards, ANY shape} %3 lines of text on left side of 2C divider
\newcommand{\twocldescribemiddle}{ALL hands 6+HCP, 5+}
\newcommand{\twocldescribebottom}{suit are opened;}
\newcommand{\twoclresponsetop}{NSNF, To play} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{3M INV, 3+}
\newcommand{\twoclresponsebottom}{2NT INV, 0--2, maybe offshape}

\newcommand{\twodlowtext}{6} %2D point range
\newcommand{\twodhightext}{12}
\newcommand{\twoddescribe}{95\% opened 2 of}
...
\newcommand{\twohdescribe}{longest suit}
...
\newcommand{\doubletext}{X-and-bid usu.\ $1-1/2$ suiter} %Other special doubles

%Simple overcalls:
\newcommand{\oclowtext}{(11)13+} %point range
...
\newcommand{\overcalltext}{\redreg{2-level O/C AS WEAK 2s}} %Other info about simple overcalls

% Jump overcalls
%\setboolean{jostr}{true} %strong
\setboolean{joint}{true}
\setboolean{jowea}{true} %weak
\newcommand{\jumpovercalltext}{3-level\hspace{8mm}Single\hspace{12mm}Double} %Other info about jump overcalls

% Opening preempts
%\setboolean{prsou}{true} %sound -- rule of 2/3/4
%\setboolean{prlig}{true} %light
\setboolean{prver}{true} %very light
\newcommand{\preempttext}{LTC based, \redreg{0--5 HCP}} %other info about preempts
