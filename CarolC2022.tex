...
\newcommand{\names}{Carol Cortéz -- Ellen Kuiper\namefix{}}  % use \namefix{} for \pfix{} here
...
% General approach:
\newcommand{\generalapproach}{2/1 Game Forcing\namefix{}}  % use \namefix{} for \pfix{} here
...
\newcommand{\clresponses}{2\,\rd\, response = GF Raise\pfix{}} % Resp: line under 1C
...
\newcommand{\diresponses}{3\,\bc\, response = GF Raise\pfix{}}
...
\newcommand{\majdrurytext}{2\,\bc: 3, 2\,\rd: 4\pfix{}}
...
\newcommand{\sysontext}{X, 2\,\bc\pfix{}} % Systems on after 1NT-(X), 2\c, etc...
...
\newcommand{\ntsptext}{\bluereg{Clubs}} % Other meaning for 1NT-2\s
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{\bluereg{Diamonds}} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{\redreg{minors INV}} % 1NT-3C
\newcommand{\ntdjumptext}{\redreg{minors GF}}
\newcommand{\nthjumptext}{\redreg{majors INV\pfix{}}}
\newcommand{\ntsjumptext}{\redreg{majors GF\pfix{}}} % 1NT-3S
...
\newcommand{\twonsptext}{\textrightarrow\ 3NT to play or minor(s) ST\pfix{}} % 2NT-3S
...
\newcommand{\twonothertext}{3NT: \redreg{5\,\bs\ + 4\,\rh}} % Other line in 2NT box

% 3NT
\newcommand{\threenlowtext}{} % 3NT range
\newcommand{\threenhightext}{}
\setboolean{gam3n}{true} % One suit?
\newcommand{\threenonesuittext}{Solid minor, 0 Outside A/K\pfix{}} % One suit description 3NT box
...
% Bottom of card
\newcommand{\jshifttext}{m-om GF raise, otherwise GF NAT} % jump shift responses
...
\newcommand{\ballowtext}{12} % balancing range
...
\newcommand{\firstvsdbl}{\redreg{Single suit (if \bs, good)}\pfix{}}   % 1NT-X
\newcommand{\firstvstwocl}{\redreg{\bc\,+ higher\pfix{}}\pfix{}} % 1NT-2C
\newcommand{\firstvstwodi}{\redreg{\rd\,+ higher\pfix{}}\pfix{}} % 1NT-2D
\newcommand{\firstvstwohe}{\redreg{\rh\,+ \bs}\xfix{}} % 1NT-2H
\newcommand{\firstvstwosp}{bad spades\pfix{}} % 1NT-2S
\newcommand{\firstvstwont}{\redreg{\bc\,+ \rd}\xfix{}} % 1NT-2NT
...
\newcommand{\othernt}{3\,x NAT PRE} % other NT defense info
...
\newcommand{\threelevelstylebottom}{Sound VUL, aggressive NV\pfix{}}
...
\newcommand{\gerbertext}{First and last NT only\pfix{}}
...
\newcommand{\trumpsignaltext}{suit preference\pfix{}}
