...
\newcommand{\clresponses}{2\,\rd\, response = GF Raise} % Resp: line under 1C
...
\newcommand{\diresponses}{3\,\bc\, response = GF Raise}
...
\newcommand{\nthjumptext}{\redreg{majors INV}}
\newcommand{\ntsjumptext}{\redreg{majors GF}} % 1NT-3S
...
\newcommand{\twonsptext}{\textrightarrow\ 3NT to play or minor(s) ST} % 2NT-3S
...
\newcommand{\firstvsdbl}{\redreg{Single suit (if \bs, good)}}   % 1NT-X
...
\newcommand{\firstvstwosp}{bad spades} % 1NT-2S
...
\newcommand{\threelevelstylebottom}{Sound VUL, aggressive NV}
...
\newcommand{\gerbertext}{First and last NT only}
...
\newcommand{\trumpsignaltext}{suit preference}
