...
\newcommand{\bidspreptop}{1NT--2\c\ Keri\hspace{5mm}Upside Down Suit Preference} % Bids that Require Preparation
...
\newcommand{\altntresponse}{could have singleton A or K in a minor, could be 6m322~\boldtext{[\ref{itm:1nt}]}}
...
\newcommand{\ntditext}{very rare 4\,\rh~\boldtext{[\ref{itm:1ntother}]}} %Other meaning for 1NT-2\d
...
\newcommand{\ntothertextbottom}{\regtext{Over 1NT--X,} 2\,\bc\ scramble, \regtext{all else to play}~\boldtext{[\ref{itm:1ntx}]}} % second "Other Conventions"
...
\newcommand{\directconvtext}{1NT takeout, 3+ in unbid suits~\boldtext{[\ref{itm:1ntoc}]}}
...
\newcommand{\threelevelstylebottom}{but 3m 1\textsuperscript{st}/2\textsuperscript{nd} "happy to play 3NT"~\boldtext{[\ref{itm:3m}]}}
...
\begin{scriptsize}
    \begin{enumerate}
        ...
        \begin{enumerate}[label*=\arabic*.,nosep]
            ...
            \end{itemize}
%            \item \label{wk2resp}Weak 2 responses:
%            \begin{description}[nosep]
%                \item [RONF] Raises are our only Non-Forcing bids, and we are aggressive and Law-abiding with them.
%                \item [2\,NT] Ogust. 3\,m/M shows bad/good hand, low/high of pair shows bad/good suit.
