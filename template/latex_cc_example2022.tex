...
\newcommand{\majraisetext}{1\,M--3NT 5card, weak, A or K outside } % Text line for Bergen, fitjumps, etc
\setboolean{dru2c}{true} % 2 Clubs Drury?
\setboolean{dru2d}{true} % 2 Diamonds Drury?
%\setboolean{drcmp}{true}
\newcommand{\majdrurytext}{2\,\bc 3-card, 2\,\rd 4-card 8-11}
...
\newcommand{\vsstrongart}{CRaSh (inc. 1\,\bc--1\,\rd)} % vs str/VS openings
