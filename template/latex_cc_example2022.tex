...
\newcommand{\names}{The Duck -- Anony Mouse\pfix{}}
...
\newcommand{\twonsptext}{\redreg{\textrightarrow 3NT, to play or minor(s) ST}\pfix{}} % 2NT-3S
...
\newcommand{\twoddescribe}{Disciplined 1\textsuperscript{st} and 2\textsuperscript{nd}\pfix{}}
...
% Bottom of card
\newcommand{\jshifttext}{Soloway in non-comp, Fit J/S in comp and by PH\pfix{}} % jump shift responses
...
\newcommand{\footnotesbottom}{\redreg{CRaSh after strong 1\,\bc--1\,\rd}\pfix{}}
...
\newcommand{\doubleothertext}{Snapdragon, DSIX at 3-level\pfix{}} % Other special doubles
...
\newcommand{\jumpovercalltext}{First 2 Jump O/C Roman\pfix{}} % Other info about jump overcalls
...
% Defense vs. NT
\newcommand{\firstcondition}{Strong Direct\pfix{}} % ''vs.'' line, first half
...
\newcommand{\firstvstwohe}{\bluereg{Spades}\pfix{}} % 1NT-2H
...
\newcommand{\secondvstwocl}{\bc\xfix{}}
\newcommand{\secondvstwodi}{\rd\xfix{}}
\newcommand{\secondvstwohe}{\rh\xfix{}}
\newcommand{\secondvstwosp}{\bs\xfix{}}
...
\newcommand{\threelevelstylebottom}{Anything in 3rd\pfix{}}
...
\newcommand{\controlcuetext}{Italian Style\pfix{}}
