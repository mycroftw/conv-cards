...
\newcommand{\ntsptext}{\c (gap neg)} %1NT-2S
\newcommand{\ntnttext}{\d (gap neg)} %1NT-2NT
...
\newcommand{\convnttext}{3NT Gambling, 0 o/s} % Blank lines under 3NT box
...
\newcommand{\twodresponse}{Feature ask (3NT only)}
...
\newcommand{\twohresponse}{2NT: 3x short, 3NT Feature}
...
\newcommand{\twosresponse}{2NT: 3x short, 3NT Feature}
...
\newcommand{\footnotesbottom}{CRaSh vs strong or "CBS" 1m}
...
\newcommand{\overcalltext}{Cue = F1, Jump cue if possible: LR}
