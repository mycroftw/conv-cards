...
\newcommand{\names}{Michael Farebrother --- Doug Mann}
\newcommand{\playernumber}{Q550794 --- }

%General approach:
\newcommand{\generalapproach}{Calgary Standard 2/1}
...
\newcommand{\ntsptext}{\c\ \redreg{(gap neg)}\pfix} %1NT-2S
\newcommand{\ntnttext}{\rd\ \redreg{(gap neg)}\pfix} %1NT-2NT
...
\newcommand{\ntextratext}{\redreg{DONT runout/PEN X}} %Blank line next to puppet Stayman
...
\newcommand{\twonsptext}{$\rightarrow$ 3NT, one- or } %2NT-3S
\newcommand{\twonextratext}{two-minor slam try\pfix} %Blank line in 2NT box
\newcommand{\threenlowtext}{} %3NT range
\newcommand{\threenhightext}{}
\newcommand{\threenextratext}{} %Blank line in 3NT box
\newcommand{\convnttext}{3NT Gambling, 0 o/s\pfix} % Blank lines under 3NT box
...
\newcommand{\majraisetext}{Kokish GT} %Text line for Bergen, fitjumps, etc
...
\newcommand{\majthreenhightext}{16}
\newcommand{\majthreennote}{3M433} %Empty space next to the 1M-3NT box: I might write ``4333'' here if I play 1M-3NT as a 13-15 4333 hand.
...
\newcommand{\twocldescribetop}{or 8.5 PT w/Def} %3 lines of text on left side of 2C divider
\newcommand{\twocldescribemiddle}{}
\newcommand{\twocldescribebottom}{GF}
\newcommand{\twoclresponsetop}{2\ \rh\, u-negative\pfix} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{2NT = \rh}
\newcommand{\twoclresponsebottom}{}

\newcommand{\twodlowtext}{6} %2D point range
\newcommand{\twodhightext}{11}
\newcommand{\twoddescribe}{}
\newcommand{\twodresponse}{Feature ask (3NT only)\pfix}
...
\newcommand{\twohresponse}{2NT: 3x short, 3NT Feature\pfix}
...
\newcommand{\twosresponse}{2NT: 3x short, 3NT Feature\pfix}
...
\newcommand{\footnotestop}{Unusual v.\ Unusual (Low shows Low)} % 3 lines for additional conventions at bottom
\newcommand{\footnotesmiddle}{}
\newcommand{\footnotesbottom}{CRaSh vs strong or "could be short" 1m\pfix}
...
%Simple overcalls:
\newcommand{\oclowtext}{6} %point range
...
\newcommand{\overcalltext}{Cue = F1, Jump cue if possible: LR\pfix}

% Jump overcalls
%\setboolean{jostr}{true} %strong
%\setboolean{joint}{true}
\setboolean{jowea}{true} %weak
\newcommand{\jumpovercalltext}{\redreg{INV in BAL}} %Other info about jump overcalls
...
\newcommand{\firstvstwocl}{\redreg{\rd\ or M+m}} %1NT-2C
...
\newcommand{\firstvsdbl}{PEN} %1NT-X
...
\newcommand{\othernttop}{\bluereg{2NT=\c,}\redreg{\ 3\c\ minors, 3\d\ Majors\pfix}} %two lines of other NT defense info
...
\newcommand{\slamtexttop}{Specific K} %Two lines for slam convention info
