...
\newcommand{\names}{\boldtext{Michael Farebrother / Tom Nault}}
\newcommand{\playernumber}{\regtext{Q550794 / J654223}}

%General approach:
\newcommand{\generalapproach}{\bigboldtext{Calgary 2/1}}
...
\newcommand{\sysontext}{\regtext{\hspace{-2 mm}X,ART 2\c}} %Systems on after 1NT-(X), 2\c, etc...
\setboolean{staym}{true}
%\setboolean{puppe}{true}
\setboolean{jac2d}{true}
%\setboolean{fstay}{true}
\setboolean{jac2h}{true}
\newcommand{\ntsptext}{\bluereg{\textrightarrow\ 3} \c\ } %1NT-2S
\newcommand{\ntnttext}{\bluereg{\textrightarrow\ 3 \rd\ }} %1NT-2NT

%NT openings - 2nd column:
\newcommand{\ntcjumptext}{\regtext{INV 2 / top 3\pfix}} %1NT-3C
\newcommand{\ntdjumptext}{\regtext{INV 2 / top 3\pfix}}
\newcommand{\nthjumptext}{\regtext{INV 2 / top 3\pfix}}
\newcommand{\ntsjumptext}{\regtext{INV 2 / top 3\pfix}} %1NT-3S
...
\newcommand{\ntnegtext}{\regtext{\hspace{-1 mm}3-level only\pfix}} %Negative doubles over 1NT?
\newcommand{\ntothertext}{\regtext{Superaccept shows bad suit\pfix}} %Other conventions over 1NT
...
\newcommand{\twonsptext}{one- or two-minor} %2NT-3S
...
\newcommand{\majraisetext}{\redreg{mini-spl,all LR\textrightarrow1NT, Const Raise\pfix}} %Text line for Bergen, fitjumps, etc
...
\newcommand{\majthreenlowtext}{16} %1M-3NT range
\newcommand{\majthreenhightext}{17}
...
\newcommand{\majothertext}{\redreg{HSGT, 123Trump GT\pfix}} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\diopennote}{\regtext{4 unless 4=4=3=2}} % Insert text in blank space next to 1D e.g. ``4 unless 4-4-3-2''
...
\newcommand{\minraisetext}{\redreg{J/S in om LR}} %Textbox next to inverted raise
\setboolean{bypas}{true}
\newcommand{\minonenlowtext}{\regtext{\hspace{-1 mm}8 (6/ \rd)}} %1C-1NT range
\newcommand{\minonenhightext}{\regtext{10}}
%\setboolean{m2ntf}{true} %1C-2NT
\setboolean{m2nti}{true}
\newcommand{\mintwonlowtext}{\regtext{11}}
\newcommand{\mintwonhightext}{\regtext{12}}
\newcommand{\minthreenlowtext}{\regtext{16}}
\newcommand{\minthreenhightext}{\regtext{17}}
\newcommand{\minothertext}{\redreg{WJS \textrightarrow M}} %Other minor suit methods (1m-3M splinter etc)
...
\newcommand{\twochightext}{\regtext{+}}
\newcommand{\twocldescribetop}{or 8.5+QT w/defence\pfix} %3 lines of text on left side of 2C divider
\newcommand{\twocldescribemiddle}{\regtext{}}
\newcommand{\twocldescribebottom}{\regtext{\hspace{-40 mm}GF}}
\newcommand{\twoclresponsetop}{\redreg{2 \rh\,= No A or K or QQ\pfix}} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{\redreg{2NT = \rh}}
\newcommand{\twoclresponsebottom}{}

\newcommand{\twodlowtext}{\regtext{6}} %2D point range
\newcommand{\twodhightext}{\regtext{12}}
\newcommand{\twoddescribe}{good 5, any 6, \textellipsis\pfix}
\newcommand{\twodresponse}{\regtext{6 card Easy Ogust,\pfix}}
...
%2H:
\newcommand{\twohlowtext}{\regtext{6}}
\newcommand{\twohhightext}{\regtext{11}}
\newcommand{\twohdescribe}{\textellipsis weak 7 cd suit}
\newcommand{\twohresponse}{\regtext{Goldman Rs/X,Parking Lot XX\pfix}}
...
%2S:
\newcommand{\twoslowtext}{\regtext{6}}
\newcommand{\twoshightext}{\regtext{11}}
\newcommand{\twosdescribe}{Disciplined 2nd only\pfix}
\newcommand{\twosresponse}{\regtext{RONF}}
...
\newcommand{\wjstext}{\redreg{only 1m-2M\pfix}}
%\setboolean{fsfrd}{true} %Fourth suit
\setboolean{fsfgf}{true}
\newcommand{\footnotestop}{\redreg{Lebensohl/reverses; cue often good raise\pfix}} % 3 lines for additional conventions at bottom
\newcommand{\footnotesmiddle}{\redreg{1m-2m: 2M, 3om \textrightarrow\, stoppers in other 2 suits; 3m 1 outside stopper\pfix}}
\newcommand{\footnotesbottom}{\redreg{\hspace{9 mm}2NT > 3NT, 4m RKC by both\pfix}}
...
\newcommand{\suppxthru}{\regtext{2x}}
\setboolean{supxx}{true} %Support redouble
\setboolean{cardx}{true}
%\setboolean{ostox}{true}
\newcommand{\doubletext}{\regtext{2 level often T/O; 3 level DSIP}} %Other special doubles

%Simple overcalls:
\newcommand{\oclowtext}{\regtext{8}} %point range
\newcommand{\ochightext}{\regtext{+}}
...
\newcommand{\overcalltext}{\regtext{NSNFConst by PH, Cue=LR+\pfix}} %Other info about simple overcalls
...
\newcommand{\preempttext}{minors\hspace{3 mm}Majors\pfix} %other info about preempts
...
\newcommand{\cuebidtext}{Strong Club defence\pfix} %other cuebid comments
...
\newcommand{\balhightext}{\regtext{14}}
...
%Defense vs. NT:
\newcommand{\firstcondition}{\regtext{Strong\pfix}} %''vs.'' line, first half
\newcommand{\firstvstwocl}{\c\ + \redreg{higher\pfix}} %1NT-2C
\newcommand{\firstvstwodi}{\redreg{\d\ + higher\pfix}} %1NT-2D
\newcommand{\firstvstwohe}{\redreg{\h\ + }\s } %1NT-2H
\newcommand{\firstvstwosp}{\regtext{poor \s\pfix}} %1NT-2S
...
\newcommand{\othernttop}{NAT vs Weak (<16 max)\pfix} %two lines of other NT defense info
...
\newcommand{\slamtexttop}{\regtext{NO GERBER EVER\hspace{5 mm} 4NT reg BLK 1st round\pfix}} %Two lines for slam convention info
\newcommand{\slamtextbottom}{Specific K\pfix}
\newcommand{\dopilevel}{\hspace{-40 mm}6 level} %DOPI/ROPI level
...
\newcommand{\signaltexttop}{T1 from length: high, low switch}
\newcommand{\signaltextbottom}{middle only encourage}
