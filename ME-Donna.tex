...
\newcommand{\names}{Michael Farebrother/Ellen Kuiper --- Donna McElroy}
\newcommand{\playernumber}{R971165}
...
\newcommand{\convnttext}{\hspace{-2mm}Gambling 3NT - zero O/S} % Blank lines under 3NT box
...
\newcommand{\majraisetext}{Bergen: 3 \rd\ limit} %Text line for Bergen, fitjumps, etc
...
\newcommand{\minraisetext}{Lim+, off comp/PH\pfix} %Textbox next to inverted raise
...
\newcommand{\twoclresponsetop}{2 \rh\ U-Neg\pfix} %3 lines of text on right side of 2C divider
...
\newcommand{\twoddescribe}{Disciplined 1+2\pfix}
...
\newcommand{\twohdescribe}{Disciplined 1+2\pfix}
\newcommand{\twohresponse}{Feature Ask}
...
\newcommand{\twosdescribe}{Disciplined 1+2\pfix}
\newcommand{\twosresponse}{Feature Ask}
...
\newcommand{\preempttext}{\hspace{2mm}Vul\hspace{5mm}NV} %other info about preempts
...
\newcommand{\firstvstwocl}{\redreg{\c\ + Higher\}pfix} %1NT-2C
\newcommand{\firstvstwodi}{\redreg{\rd\ + Major}\pfix} %1NT-2D
\newcommand{\firstvstwohe}{\regtext{Hearts}} %1NT-2H
\newcommand{\firstvstwosp}{\regtext{Spades}\pfix} %1NT-2S
\newcommand{\firstvsdbl}{\redreg{one minor or both Majors}\pfix} %1NT-X
...
\newcommand{\xxtext}{\hspace{2mm}10+} %Blank space next to Rdbl implies no fit. Can write in ``any 10+''
...
\newcommand{\slamtexttop}{Gerber: first and last NT only\pfix} %Two lines for slam convention info
\newcommand{\slamtextbottom}{}
\newcommand{\dopilevel}{5 x} %DOPI/ROPI level
