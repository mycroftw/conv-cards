...
%General approach:
\newcommand{\generalapproach}{Phantom Club Normal: WARNING not GCC legal}
...
\newcommand{\convnttext}{2NT Minors, 5--11} % Blank lines under 3NT box
...
\newcommand{\majothertext}{2,\c{} drury by UPH, FitJ/S} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\clopennote}{15+ or t/o \c} % Insert text in blank space next to 1C
\newcommand{\diopennote}{usually 5+} % Insert text in blank space next to 1D e.g. ``4 unless 4-4-3-2''
...
\newcommand{\minothertext}{2,\c{} / 1\rd{\d} Limit+, FJS/\rd{\d}} %Other minor suit methods (1m-3M splinter etc)
...
\newcommand{\twoclowtext}{5} %2C point range
\newcommand{\twochightext}{14}
\newcommand{\twocldescribetop}{5=5+ Majors} %3 lines of text on left side of 2C divider
...
\newcommand{\twodlowtext}{3} %2D point range
\newcommand{\twodhightext}{8}
\newcommand{\twoddescribe}{6 cards, \ldots}
\newcommand{\twodresponse}{Ogust, RONF}
...
%2H:
\newcommand{\twohlowtext}{3}
\newcommand{\twohhightext}{8}
\newcommand{\twohdescribe}{\ldots"Anything goes"\ldots\pfix{}}
...
%2S:
\newcommand{\twoslowtext}{3}
\newcommand{\twoshightext}{8}
