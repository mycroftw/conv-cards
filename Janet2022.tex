...
\newcommand{\names}{Janet Galbraith -- Michael Farebrother}
\newcommand{\playernumber}{R996850/Q550794}
...
% General approach:
\newcommand{\generalapproach}{Calgary 2/1 with Eastern Feel\namefix{}}
...
\newcommand{\bidspreptop}{NT Defence (Hello) vs NT O/C\pfix{}} % Bids that Require Preparation
...
\newcommand{\clresponses}{Fit Jump Shifts\pfix{}} % Resp: line under 1C
%\setboolean{ctxfr}{true} % transfer responses to 1C

\newcommand{\clrespdi}{Could be 3} % text after "1D response"
...
\newcommand{\majothertextbottom}{\hspace{45mm}Drury: 2\,\bc\,= 4\,M 8--11, 2\,\rd\,= 3\,M LR\pfix{}} % Other major methods line two
...
\newcommand{\altntresponse}{could have singleton A or K in a minor, could be 6m322\pfix{}}

% 1NT: First column
%\setboolean{nt5cm}{true}
\newcommand{\sysontext}{ART X, 2\,\bc\pfix{}} % Systems on after 1NT-(X), 2\c, etc...
...
\newcommand{\ntsptext}{\textrightarrow\,\bc\,(gap neg)\pfix{}} % Other meaning for 1NT-2\s
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{\textrightarrow\,\rd\,(gap neg)\pfix{}} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{\redreg{5-5 minors weak}} % 1NT-3C
\newcommand{\ntdjumptext}{\redreg{5-5 minors GF}}
\newcommand{\nthjumptext}{\redreg{3=1--(5\,4)}}
\newcommand{\ntsjumptext}{\redreg{1=3--(5\,4)}} % 1NT-3S
\newcommand{\ntothertexttop}{DONT runout / PEN X (pass to play)\pfix{}} % Other conventions over 1NT
...
\newcommand{\threenonesuittext}{solid minor, 0 outside\pfix{}} % One suit description 3NT box
...
\newcommand{\twoclconvtext}{\hspace{-1mm}2\,\rh\,rebid Kokish}
...
\newcommand{\twoclresponse}{X, XX neg; P GF\pfix{}} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{6} % 2D point range
\newcommand{\twodhightext}{10}
\newcommand{\twoddescribe}{Sound style\pfix{}}
...
\newcommand{\twodntresp}{Feat.\@ (3NT Y)\pfix{}}
...
% Bottom of card
\newcommand{\jshifttext}{Fit (9+ cards, limitish strength)\pfix{}} % jump shift responses
...
\newcommand{\footnotestop}{NT defence vs NT Overcalls} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{Unusual vs Unusual (low = low)\hspace{10mm}Ingbermann/Rev (2\,M over 2\,\rd)\pfix{}}
...
\newcommand{\directconvtext}{Cue = Stayman/BAL NTO\pfix{}}
\setboolean{unu2l}{true} % Unusual: 2 lowers
\newcommand{\ntothertext}{} % conventional overcalls (sandwich etc)

% Overcalls
\newcommand{\oclowtext}{7+} % 1-level point range
...
\newcommand{\jumpovercalltext}{Intermediate/BAL} % Other info about jump overcalls
...
\newcommand{\overcallcuetext}{sound raise}
\setboolean{occus}{true} % cue response support?
\newcommand{\overcallothertext}{Jump Cue = Mixed Raise\pfix{}} % Other responses

% Defense vs. NT
\newcommand{\firstcondition}{all} % ''vs.'' line, first half
\newcommand{\firstvsdbl}{\regtext{Penalty}\pfix{}}   % 1NT-X
\newcommand{\firstvstwocl}{\redreg{\rd\, or Major + minor}} % 1NT-2C
\newcommand{\firstvstwodi}{\redreg{Hearts}} % 1NT-2D
\newcommand{\firstvstwohe}{\redreg{Majors}\pfix{}} % 1NT-2H
\newcommand{\firstvstwosp}{\regtext{Spades}\pfix{}} % 1NT-2S
\newcommand{\firstvstwont}{\redreg{Clubs}} % 1NT-2NT
...
\newcommand{\othernt}{3\,\bc\,= minors; 3\,\rd\,= Majors, strong\pfix{}} % other NT defense info
...
% Opening preempts
\newcommand{\threelevelstyletop}{Sound style, esp 2\textsuperscript{nd}\pfix{}}
\newcommand{\threelevelstylebottom}{3\textsuperscript{rd} seat much more free}
...
\newcommand{\blackwoodtext}{Specific Ks\pfix{}}
\newcommand{\controlcuetext}{1\textsuperscript{st}/2\textsuperscript{nd}}
\newcommand{\slaminterftext}{DOPI, DEPO past 5x\pfix{}}
...
\newcommand{\trumpsignaltext}{hi-lo suggests ruff\pfix{}}
