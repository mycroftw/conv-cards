...
% General approach:
\newcommand{\generalapproach}{Calgary 2/1 with Eastern Feel\pfix{}}
...
\newcommand{\bidspreptop}{NT Defence (Hello) vs NT O/C} % Bids that Require Preparation
...
\newcommand{\sysontext}{ART X, 2\,\bc} % Systems on after 1NT-(X), 2\c, etc...
...
\newcommand{\twoclconvtext}{2\,\rh\,rebid Kokish}
...
\newcommand{\twodntresp}{Feat.\@ (3x N/3NT Y)}
...
% Bottom of card
\newcommand{\jshifttext}{Fit (9+ cards, limitish strength)} % jump shift responses
...
\newcommand{\overcallothertext}{Jump Cue = Mixed Raise} % Other responses
