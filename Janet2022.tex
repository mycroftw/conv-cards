...
\newcommand{\clresponses}{Fit Jump Shifts} % Resp: line under 1C
...
\newcommand{\majothertextbottom}{\hspace{45mm}Drury: 2\,\bc\,= 4\,M 8--11, 2\,\rd\,= 3\,M LR} % Other major methods line two

\setboolean{ra2nt}{true} % Jacoby
\setboolean{ra3nt}{true} % 1M-3NT
\setboolean{raspl}{true} % Splinter
\newcommand{\majraisetext}{Fit Jump Shifts, Kokish Game Tries} % Text line for Bergen, fitjumps, etc
...
\newcommand{\ntsptext}{\textrightarrow\,\bc\,(gap neg)} % Other meaning for 1NT-2\s
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{\textrightarrow\,\rd\,(gap neg)} % Other meaning for 1NT-2NT
...
\newcommand{\ntothertexttop}{DONT runout / PEN X (pass to play)} % Other conventions over 1NT
...
\newcommand{\twoclresponse}{X, XX neg; P GF} % Other text on right side of 2C divider
...
\newcommand{\twodntresp}{Feat.\@ (3NT Y)}
...
\newcommand{\footnotesbottom}{Unusual vs Unusual (low = low)\hspace{10mm}Ingbermann/Rev (2\,M over 2\,\rd)}
...
\newcommand{\directconvtext}{Cue = Stayman/BAL NTO}
...
\newcommand{\firstvsdbl}{\regtext{Penalty}}   % 1NT-X
...
\newcommand{\firstvstwosp}{\regtext{Spades}} % 1NT-2S
...
\newcommand{\othernt}{3\,\bc\,= minors; 3\,\rd\,= Majors, strong} % other NT defense info
...
% Opening preempts
\newcommand{\threelevelstyletop}{Sound style, esp 2\textsuperscript{nd}}
...
\newcommand{\blackwoodtext}{Specific Ks}
\newcommand{\controlcuetext}{1\textsuperscript{st}/2\textsuperscript{nd}}
\newcommand{\slaminterftext}{DOPI, DEPO past 5x}
...
\newcommand{\trumpsignaltext}{hi-lo suggests ruff}
