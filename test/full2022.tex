...
\newcommand{\majothertexttop}{HSGT, fit J/S in comp} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\majraisetext}{J/S mini Splinter, Kokish GTry} %Text line for Bergen, fitjumps, etc
...
\newcommand{\ntditext}{GF Stay} %Other meaning for 1NT-2\d
\setboolean{nat2h}{true}
\setboolean{jac2h}{true}
\newcommand{\nthetext}{\s + m} %Other meaning for 1NT-2\h
...
\newcommand{\nthjumptext}{Majors INV}
\newcommand{\ntsjumptext}{Majors GF} %1NT-3S
\newcommand{\ntothertexttop}{Over weak: 2-way, no smol/tex} %Other conventions over 1NT
\newcommand{\ntothertextbottom}{\hspace{4mm}and negX throughout} %blank line after texas transfers
...
\newcommand{\twonothertext}{slam try} %Blank line in 2NT box

\newcommand{\threenlowtext}{24} %3NT range
\newcommand{\threenhightext}{27}
\setboolean{gam3n}{true}
\newcommand{\threenonesuittext}{solid suit (0 outside)} %One suit description 3NT box
...
\newcommand{\twodresponse}{2M fr.psych}

%2H:
\newcommand{\twohlowtext}{5}
\newcommand{\twohhightext}{10}
\newcommand{\twohdescribe}{crazy, usually}
...
\newcommand{\twosresponse}{Bingo}

%Bottom of card:
\newcommand{\jshifttext}{Weak NC, Fit in comp or by PH} % jump shift responses
...
\newcommand{\toxstyletext}{very aggr. w/perfect shape}
\newcommand{\doubleothertext}{Rosencrans, snapdragon} %Other special doubles
...
\newcommand{\directconvtext}{Raptor: 4\,M -- 5\,+m}
...
\newcommand{\firstvstwodi}{Majors} %1NT-2D
\newcommand{\firstvstwohe}{\rh} %1NT-2H
\newcommand{\firstvstwosp}{\s} %1NT-2S
...
%vs. opening preempts
\newcommand{\optwontoc}{15--17 Bal w/stop} % (2x)-2NT
...
\newcommand{\opothertext}{spl only in pre suit} %Other line

%Slam conventions
\setboolean{gednt}{true} %Gerber
\setboolean{geseq}{true} %NT Seq G
\setboolean{genon}{true} %non-seq G
\newcommand{\gerbertext}{1430/Sty or Trf}
...
\newcommand{\slaminterftext}{DFS/PSS, DEPO (5 trump+)}
\newcommand{\slamothertext}{2\c\ opener's suit is trump unless suit agreement} %Two lines for slam convention info
...
\newcommand{\trumpsignaltext}{suit pref w/obvious}
...
\newcommand{\signaltexttop}{Lavinthal vs NT only}
...
\newcommand{\suitexceptbottom}{frequent suit preference leads}
