...
\newcommand{\minHCPopen}{12 (11 M)\pfix{}}
\newcommand{\minHCPresp}{A or 6 (5/m)\pfix{}}
%\setboolean{fo1c}{true} %Forcing openings...
\setboolean{fo2c}{true}
\newcommand{\foothertext}{4\bc, 4\rd\pfix{}}%Other forcing opening bids
%\setboolean{1nts}{true} % 1NT strength
\setboolean{1ntw}{true}
%\setboolean{1ntv}{true}
\newcommand{\bidspreptop}{1NT--2\c\ Keri, Upside Down Suit Preference\pfix{}} % Bids that Require Preparation
\newcommand{\bidsprepbottom}{1NT Overcall takeout, 1 suit-X 15+ "any"\hspace{9mm}Notes [\#] on back for detail\pfix{}} % Bids that Require Prep line 2
...
\newcommand{\didescribe}{4 unless 4--4--3--2, sound unless 6+\ \rd\pfix{}} % Insert text in blank space next to 1D e.g. ``4 unless 4-4-3-2''
...
\newcommand{\majraisetext}{Fit J/S (Limit-ish)\pfix{}} %Text line for Bergen, fitjumps, etc
...
\newcommand{\ntditext}{very rare 4\,\rh\,\boldtext{[1.3]}\pfix{}} %Other meaning for 1NT-2\d
%\setboolean{nat2h}{true}
\setboolean{jac2h}{true}
\newcommand{\nthetext}{} %Other meaning for 1NT-2\h
%\setboolean{nat2s}{true}
%\setboolean{trf2s}{true}
\newcommand{\ntsptext}{range ask \boldtext{[1.3]}\pfix{}} %1NT-2S
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{\regtext{clubs}} %1NT-2NT

% 1NT: second column
\newcommand{\ntcjumptext}{\rd\ \redreg{splinter\ \boldtext{[1.3]}}\pfix{}} %1NT-3C
\newcommand{\ntdjumptext}{\rh\ \redreg{splinter}\pfix{}}
\newcommand{\nthjumptext}{\s\ \redreg{splinter}\pfix{}}
\newcommand{\ntsjumptext}{\c\ \redreg{splinter}\pfix{}} %1NT-3S
\newcommand{\ntothertexttop}{2\,\bc\ forces 2\,\rd, to play or INV \boldtext{[1.1]}\pfix{}} %Other conventions over 1NT
\newcommand{\ntothertextbottom}{\regtext{Over 1NT--X,} 2\,\bc\ scramble, \regtext{all else to play} \boldtext{[1.4]}\pfix{}} % second "Other Conventions"
...
\newcommand{\twonothertext}{SATexas} %Other line in 2NT box

% 3NT
\newcommand{\threenlowtext}{} %3NT range
\newcommand{\threenhightext}{}
\setboolean{gam3n}{true} % One suit?
\newcommand{\threenonesuittext}{4m preempt, NOT solid\pfix{}} %One suit description 3NT box
...
\newcommand{\twoclresponse}{cheapest 3, x, xx 2-neg\pfix{}} %Other text on right side of 2C divider
...
\newcommand{\twohresponse}{..ParkingLot XX\pfix{}}
...
%Bottom of card
\newcommand{\jshifttext}{Fit (Limit-ish, 9+ in two suits)\pfix{}} % jump shift responses
...
\newcommand{\footnotestop}{Wolff Signoff after 1\,x--1\,y; 2NT\pfix{}} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{Very aggressive competition against 2-fit\pfix{}}
...
\newcommand{\suppxthru}{2x (-1NT)\pfix{}}
\setboolean{supxx}{true} %Support redouble
\newcommand{\toxstyletext}{\redreg{15+ "any" (xx+ if min.) \boldtext{[2.1]}}\pfix{}}
\newcommand{\doubleothertext}{see 1NT for takeout "double"} %Other special doubles

% NT overcalls
\newcommand{\directlowtext}{\redreg{(6)\,8}\pfix{}} %range
\newcommand{\directhightext}{\redreg{14(18)}\pfix{}}
...
\newcommand{\firstvstwodi}{\rh\,\redbold{ or }\bs\xfix{}} %1NT-2D
...
\newcommand{\secondcondition}{Weak (< 16)\pfix{}} %the same six lines, right half
...
\newcommand{\cuebiddescribe}{Mathé vs Str, std vs multi-1m\pfix{}} % other cuebid comments
...
% Opening preempts
\newcommand{\threelevelstyletop}{Aggressive (esp NV)\pfix{}}
\newcommand{\threelevelstylebottom}{but 3m 1\textsuperscript{st}/2\textsuperscript{nd} "happy to play 3NT" \boldtext{[6]}\pfix{}}
\newcommand{\threelevelresp}{NSF}
\newcommand{\fourlevelstyle}{4m Solid M, or 1-loser+A or K}
\newcommand{\fourlevelresp}{gap asks which\pfix{}}
...
\newcommand{\controlcuetext}{1\textsuperscript{st}/2\textsuperscript{nd} up the line, Frivolous 3NT/M\pfix{}}
\newcommand{\slaminterftext}{DFS/RFS/PSS, DEPO $\rightarrow$ 5 trump\pfix{}}
\newcommand{\slamothertext}{1NT--2\,\s; resp-3\,x RKC\pfix{}} %Two lines for slam convention info
...
\newcommand{\othercardingtext}{\boldtext{Upside Down Suit Pref. [5]}\pfix{}}
\newcommand{\trumpsignaltext}{(UD)SP\pfix{}}
...
\newcommand{\signalexcepttext}{Frequent Suit Pref. Leads\pfix{}}
