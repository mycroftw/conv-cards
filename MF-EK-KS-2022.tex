...
\newcommand{\names}{Michael Farebrother -- Ellen Kuiper\pfix{}}
...
%General approach:
\newcommand{\generalapproach}{Weak NT, Keri/NT\pfix{}}
...
\newcommand{\bidsprepbottom}{1NT Overcall takeout, 1suit-X 15+ "any"\hspace{9mm}Notes [\#] on back for detail\pfix{}} % Bids that Require Prep line 2
...
\newcommand{\ntditext}{very rare 4\,\rh\,\boldtext{[2]}\pfix{}} %Other meaning for 1NT-2\d
%\setboolean{nat2h}{true}
\setboolean{jac2h}{true}
\newcommand{\nthetext}{} %Other meaning for 1NT-2\h
%\setboolean{nat2s}{true}
%\setboolean{trf2s}{true}
\newcommand{\ntsptext}{Range Ask \boldtext{[2]}\pfix{}} %1NT-2S
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{\regtext{clubs}} %1NT-2NT

% 1NT: second column
\newcommand{\ntcjumptext}{\rd\ \redreg{splinter\ }\boldtext{[2]}\pfix{}} %1NT-3C
\newcommand{\ntdjumptext}{\rh\ \redreg{splinter}\pfix{}}
\newcommand{\nthjumptext}{\s\ \redreg{splinter}\pfix{}}
\newcommand{\ntsjumptext}{\c\ \redreg{splinter}\pfix{}} %1NT-3S
\newcommand{\ntothertexttop}{2\,\bc\ forces 2\,\rd, to play or INV \boldtext{[1]}\pfix{}} %Other conventions over 1NT
\newcommand{\ntothertextbottom}{\regtext{Over 1NT--X,} 2\,\bc\ scramble, \regtext{all else to play} \boldtext{[3]}\pfix{}} % second "Other Conventions"
...
\newcommand{\twoddescribe}{Anything goes style \boldtext{[7]}}
...
\newcommand{\vsstrongart}{Mathé/Str 1m} % "vs str/VS openings" - MDF to fix
...
\newcommand{\toxstyletext}{\redreg{15+ "any" (xx+ if min.) \boldtext{[5]}}\pfix{}}
\newcommand{\doubleothertext}{see 1NT for takeout "double"} %Other special doubles

% NT overcalls
\newcommand{\directlowtext}{(6)8} %range
\newcommand{\directhightext}{14(18)}
...
\newcommand{\directconvtext}{1NT takeout, 3+ in unbid suits \boldtext{[5]}\pfix{}}
...
\newcommand{\threelevelstylebottom}{but 3m 1\textsuperscript{st}/2\textsuperscript{nd} "happy to play 3NT" \boldtext{[7]}\pfix{}}
...
\newcommand{\othercardingtext}{\boldtext{Upside Down Suit Pref. [6]}\pfix{}}
