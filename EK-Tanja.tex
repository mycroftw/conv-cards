...
\newcommand{\names}{Ellen Kuiper --- Tanja Hurlbert}
...
\newcommand{\majothertext}{HSGT} %Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\twocldescribebottom}{A or K}
\newcommand{\twoclresponsetop}{2\ \rh\ Ultraneg.} %3 lines of text on right side of 2C divider
\newcommand{\twoclresponsemiddle}{2NT = \rh}
\newcommand{\twoclresponsebottom}{X, XX Uneg, P GF}
...
\newcommand{\footnotestop}{Western Que} % 3 lines for additional conventions at bottom
...
\newcommand{\preempttext}{\hspace{2mm}Vul\hspace{6mm}NV} %other info about preempts
...
\newcommand{\firstvstwodi}{\rh\ + \s} %1NT-2D
\newcommand{\firstvstwohe}{\regtext{NAT}} %1NT-2H
\newcommand{\firstvstwosp}{\regtext{NAT}} %1NT-2S
...
\newcommand{\othernttop}{2NT = minors} %two lines of other NT defense info
...
\newcommand{\xxtext}{10+} %Blank space next to Rdbl implies no fit. Can write in ``any 10+''
...
\newcommand{\opconvtakeout}{4NT / 4\ \s} %Conv Takeout line
...
\newcommand{\slamtexttop}{DONTO} %Two lines for slam convention info
