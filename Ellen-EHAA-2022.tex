...
\newcommand{\bidspreptop}{Highly Undisciplined 2 bids, VERY weak 3+bids\pfix{}} % Bids that Require Preparation
\newcommand{\bidsprepbottom}{2\,--level overcalls like 2 openers, Sound 1--level action, 10--12 1NT\pfix{}} % Bids that Require Prep line 2
...
\newcommand{\ntsptext}{Range ask\pfix{}} % Other meaning for 1NT-2\s
...
\newcommand{\nthjumptext}{\redreg{\bs\,splinter\pfix{}}}
\newcommand{\ntsjumptext}{\redreg{\bc\,splinter\pfix{}}} % 1NT-3S
\newcommand{\ntothertexttop}{2\,\bc\,Keri: to play 2\,\rd\,or various INV+\pfix{}} % Other conventions over 1NT
\newcommand{\ntothertextbottom}{After X; 2\,\bc\,scramble, all else (inc P, XX) to play\pfix{}} % Second "Other Conventions"
...
\newcommand{\twonsptext}{1- or 2-minor slam try\pfix{}} % 2NT-3S
...
\newcommand{\twoclresponse}{NSNF to play; 3-raise INV, SJS\pfix{}} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{(4)\,6} % 2D point range
\newcommand{\twodhightext}{12}
\newcommand{\twoddescribe}{\boldtext{ALL hands 6+HCP, 5+suit are opened;\pfix{}}}
...
\newcommand{\twohdescribe}{\boldtext{\textellipsis{}95\,\% are opened 2 of longest suit\pfix{}}}
...
% Bottom of card
\newcommand{\jshifttext}{\redreg{Fit J/S (Limit)/1}, Strong J/S (17+, GF) over 2\pfix{}} % jump shift responses
...
\newcommand{\footnotestop}{Unusual/Unusual (low = low)\hspace{4mm}Wolff signoff after 1\,x--1\,y; 2NT\pfix{}} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{Sound actions at 1 level, esp. opposite PH\pfix{}}
...
\newcommand{\jumpovercalltext}{3 lev: sgl-J/O INV, dbl-J/O weak\pfix{}} % Other info about jump overcalls
...
\newcommand{\overcallothertext}{2 level O/C AS WEAK 2s always\pfix{}} % Other responses

% Defense vs. NT
\newcommand{\firstcondition}{Strong/All\pfix{}} %''vs.'' line, first half
\newcommand{\firstvsdbl}{\redreg{usu. 4\,M--5+m}} %1NT-X
\newcommand{\firstvstwocl}{\rh\ \redreg{ + }\bs\xfix{}} %1NT-2C
\newcommand{\firstvstwodi}{\rh\ \redreg{ or }\bs\xfix{}} %1NT-2D
...
\newcommand{\secondvstwohe}{\redreg{\rh\ + m}\xfix{}}
\newcommand{\secondvstwosp}{\redreg{\bs\ + m}\xfix{}}
...
\newcommand{\cuebiddescribe}{Michaels Very Sound\pfix{}} % other cuebid comments
...
\newcommand{\fourlevelstyle}{As \textuparrow, -1 LT, 6+HCP poss.\pfix{}}
...
\newcommand{\slaminterftext}{DOPI / DEPO \textrightarrow\ 5 trump\pfix{}}
\newcommand{\slamothertext}{Frivolous 3NT/Major fit, 1NT-2\,\bs; rebid-new suit RKC\pfix{}} % slam convention info
...
\newcommand{\cardexcepttext}{\boldtext{Upside Down Suit Pref\pfix{}}}
...
\newcommand{\trumpsignaltext}{(UD) suit preference\pfix{}}
...
\newcommand{\signaltexttop}{Frequent suit preference second signal\pfix{}}
...
\newcommand{\suitexceptbottom}{Pd's suit low: Qxx/support, xxx/not\pfix{}}
