...
\newcommand{\names}{Ellen Kuiper -- Marc Maes}
\newcommand{\playernumber}{O007899/Q443025}
...
\newcommand{\ntcjumptext}{\redreg{5-5 m, P/C}} %1NT-3C
\newcommand{\ntdjumptext}{\redreg{5-5 m, GF}}
\newcommand{\nthjumptext}{\redreg{5-5 M, INV}}
\newcommand{\ntsjumptext}{\redreg{5-5 M, GF}} %1NT-3S
...
\newcommand{\threenextratext}{Solid minor - 0 outside} %Blank line in 3NT box
...
\newcommand{\majraisetext}{\redreg{Bergen Raises (on/X)}\pfix{}} %Text line for Bergen, fitjumps, etc
...
\newcommand{\minraisetext}{GF, J/S om LR} %Textbox next to inverted raise
\setboolean{bypas}{true}
\newcommand{\minonenlowtext}{6} %1C-1NT range
\newcommand{\minonenhightext}{9}
...
\newcommand{\twohresponse}{Goldman Raise/X}
...
\newcommand{\twowaytext}{\redreg{XYNT}}
\setboolean{wjsnc}{true} %Weak jump shifts
\newcommand{\wjstext}{\redreg{m$\rightarrow$M only}}
...
\newcommand{\firstvstwocl}{\redreg{\d\ or M+m}} %1NT-2C
\newcommand{\firstvstwodi}{\redreg{Majors}\pfix{}} %1NT-2D
\newcommand{\firstvstwohe}{\hspace{3mm}\rh} %1NT-2H
\newcommand{\firstvstwosp}{\hspace{3mm}\s} %1NT-2S
...
\newcommand{\toxothertext}{\redreg{Bergen Raises / 1M--x}\pfix{}} %Line at bottom of Opps TOX section
...
\newcommand{\dopilevel}{\hspace{-16mm}5x+} %DOPI/ROPI level
