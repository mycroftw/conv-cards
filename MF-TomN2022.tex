...
\newcommand{\bidspreptop}{1\,M: all Limit Raise via 1NT Forcing\pfix{}} % Bids that Require Preparation
\newcommand{\bidsprepbottom}{Unusual weak 2 shapes\pfix{}} % Bids that Require Prep line 2
...
\newcommand{\cldescribe}{1\,M\,rebid promises 4 Clubs\pfix{}} % blank space under 1C
...
\newcommand{\majothertextbottom}{HSGT, 123TrumpGT\pfix{}} % Other major methods line two

\setboolean{ra2nt}{true} % Jacoby
\setboolean{ra3nt}{true} % 1M-3NT
\setboolean{raspl}{true} % Splinter
\newcommand{\majraisetext}{mini-splinters, all LR\textrightarrow1NT\pfix{}} % Text line for Bergen, fitjumps, etc
...
% 1NT: Second column
\newcommand{\ntcjumptext}{INV 2/top 3\pfix{}} % 1NT-3C
\newcommand{\ntdjumptext}{INV 2/top 3\pfix{}}
\newcommand{\nthjumptext}{INV 2/top 3\pfix{}}
\newcommand{\ntsjumptext}{INV 2/top 3\pfix{}} % 1NT-3S
\newcommand{\ntothertexttop}{Superaccept shows bad suit\pfix{}} % Other conventions over 1NT
...
\newcommand{\twoclresponse}{2NT = \rh\, positive\pfix{}} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{6} % 2D point range
\newcommand{\twodhightext}{12}
\newcommand{\twoddescribe}{10-11 w/ 5 cards, any 6, bad 7\pfix{}}
...
\newcommand{\twodntresp}{5 cd, bad,ok,good\pfix{}}
...
% Bottom of card
\newcommand{\jshifttext}{Weak 1\,m\textrightarrow2\,M. 1\,m--other minor LR,  1\,M\textrightarrow2\,\bs, 3\,m/\rh\,limit splinter\pfix{}} % jump shift responses
...
\newcommand{\footnotestop}{Leb/reverses; cue often good raise\pfix{}} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{1\,m--2\,m: 2\,M, 3\,om \textrightarrow{} stoppers in other two suits; 3m 1 stopper\pfix{}}
...
\newcommand{\overcallothertext}{NSNFConst by PH\pfix{}} % Other responses

% Defense vs. NT
\newcommand{\firstcondition}{Strong\pfix{}} % ''vs.'' line, first half
\newcommand{\firstvsdbl}{\redreg{one suit}}   % 1NT-X
\newcommand{\firstvstwocl}{\redreg{\bc\,+ higher}\pfix{}} % 1NT-2C
\newcommand{\firstvstwodi}{\redreg{\rd\,+ higher}\pfix{}} % 1NT-2D
\newcommand{\firstvstwohe}{\redreg{\rh\,+ \bs}} % 1NT-2H
\newcommand{\firstvstwosp}{poor \bs{}\pfix{}}% % 1NT-2S
...
\newcommand{\secondvstwosp}{Spades\pfix{}}
...
\newcommand{\threelevelstylebottom}{sound minor, aggressive Major\pfix{}}
...
\newcommand{\blackwoodtext}{Specific Ks, 4NT 0123\,1\textsuperscript{st} round\pfix{}}
...
\newcommand{\cardexcepttext}{T1 from length: high, low SP\pfix{}}
