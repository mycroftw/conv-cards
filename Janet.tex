...
\newcommand{\ntothertext}{\redreg{DONT runout/PEN X (P to play)\pfix{}}} %Other conventions over 1NT
...
\newcommand{\twonsptext}{\hspace{-1mm}\redreg{1- or 2-minor slam try}\pfix{}} %2NT-3S
...
\newcommand{\majraisetext}{\redreg{Fit J/S, Kokish GT}} %Text line for Bergen, fitjumps, etc
...
\newcommand{\footnotestop}{NT Defence (Hello) vs NT Overcalls\hspace{5mm}Ingbermann/Rev (2M/2\rd)\pfix{}} % 3 lines for additional conventions at bottom
\newcommand{\footnotesmiddle}{Unusual v.\ Unusual (Low shows Low)\pfix{}}
...
\newcommand{\othernttop}{\redreg{2NT=Clubs;\ 3\,\c{}=minors;}\pfix{}} %two lines of other NT defense info
