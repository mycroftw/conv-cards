...
\newcommand{\playernumber}{Q550794/R996850}
...
\newcommand{\sysontext}{\hspace{-2mm}ART X, 2\,\c} %Systems on after 1NT-(X), 2\c, etc...
\setboolean{staym}{true}
%\setboolean{puppe}{true}
\setboolean{jac2d}{true}
%\setboolean{fstay}{true}
\setboolean{jac2h}{true}
\newcommand{\ntsptext}{$\rightarrow$ \c\ (gap neg)\pfix{}} %1NT-2S
...
\newcommand{\ntothertext}{DONT runout/PEN X (P to play)\pfix{}} %Other conventions over 1NT
...
\newcommand{\twonsptext}{1- or 2-minor} %2NT-3S
\newcommand{\twonextratext}{slam try} %Blank line in 2NT box
\newcommand{\threenlowtext}{} %3NT range
\newcommand{\threenhightext}{}
\newcommand{\threenextratext}{} %Blank line in 3NT box
\newcommand{\convnttext}{3NT Gambling, 0 outside\pfix{}} % Blank lines under 3NT box
...
\newcommand{\majthreenlowtext}{7} %1M-3NT range
\newcommand{\majthreenhightext}{10}
\newcommand{\majthreennote}{5+M, A/K O/S} %Empty space next to the 1M-3NT box: I might write ``4333'' here if I play 1M-3NT as a 13-15 4333 hand.
...
\newcommand{\twocldescribebottom}{X, XX neg;\ P wait,GF\pfix{}}
...
\newcommand{\footnotestop}{NT Defence (Hello) vs NT Overcalls\hspace{5mm}Ingbermann/Rev (2M/2\rd)} % 3 lines for additional conventions at bottom
\newcommand{\footnotesmiddle}{Unusual v.\ Unusual (Low shows Low)}
...
\newcommand{\overcalltext}{Jump Cue = Mixed Raise\pfix{}} %Other info about simple overcalls
...
\newcommand{\ntconvtext}{cue=Stayman/BAL NTO\pfix{}} %conventional overcalls (sandwich etc)

%Defense vs. NT:
\newcommand{\firstcondition}{} %''vs.'' line, first half
\newcommand{\firstvstwocl}{\redreg{\d\ or Major + minor}\pfix{}} %1NT-2C
\newcommand{\firstvstwodi}{\redreg{Hearts}} %1NT-2D
\newcommand{\firstvstwohe}{\redreg{Majors}\pfix{}} %1NT-2H
\newcommand{\firstvstwosp}{Spades\pfix{}} %1NT-2S
...
\newcommand{\othernttop}{\redreg{2NT=Clubs;\ 3\,\c{}=minors;}\xfix{}} %two lines of other NT defense info
\newcommand{\otherntbottom}{\redreg{3\,\rd{}=Majors, strong}\pfix{}}
